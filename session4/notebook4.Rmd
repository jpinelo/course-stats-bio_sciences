...
plot(model1.2)
```
Leverage plot: when leverage is large might be worry but not when residuals are small. high leverage mean the value of the predisctors are larger than the other points.    
...
Var Hospital is nested in var Districts
